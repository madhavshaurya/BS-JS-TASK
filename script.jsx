    ...
    return (
      <div>
        <ReactBootstrap.Input
          ...
          buttonAfter={
            <ReactBootstrap.Button onClick={this.handleClick}>
              Delete
...
var HobbyForm = React.createClass({
  getInitialState: function () {
    return {
      data: {},
      rules: new FormSchema.JsonSchemaRuleFactory(BusinessRules).CreateRule(
        'Main'
      ),
    };
  },
  ...
  result: function () {
    ...
    return Utils.CompositeDotObject.Transform(
      this.state.rules.Validate(this.state.data)
    ).Main;
  },
  render: function () {
    return (
      <div>
        <ReactBootstrap.Panel header="Hobby form" bsStyle="primary">
          <div>
            ...
            />
            <ReactBootstrap.Button onClick={this.addHobby}>
              Add hobby
            </ReactBootstrap.Button>
            &nbsp;
...
var HobbyList = React.createClass({
  ...
  render: function () {
    ...
    return <div className="commentList">{hobbyNodes}</div>;
  },
});
...
var RadioGroup = React.createClass({
  ...
  setCheckedRadio: function () {
    ...
    var destinationValue =
      this.props.value != null ? this.props.value : this.state.defaultValue;
...
React.render(<HobbyForm />, document.getElementById('content'));
